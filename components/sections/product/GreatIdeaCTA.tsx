...
export function GreatIdeaCTA({ content }: { content: ProductContent }) {
  return (
    <section className="border-b border-line bg-dark-2 py-20 md:py-28">
      <Container size="lg">
        <RevealOnScroll>
          <div className="noise-overlay relative overflow-hidden rounded-xl border-2 border-dark bg-dark shadow-sticker-lg">
            <div className="relative z-10 grid gap-8 p-8 md:grid-cols-[1.3fr_1fr] md:gap-12 md:p-12 lg:p-16">
              <div className="flex flex-col justify-center gap-6">
                ...
                <p className="max-w-md text-pretty text-lg text-cream/70">{content.cta.body}</p>
                <div className="mt-2">
