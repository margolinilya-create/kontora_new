    ...
    <section className="border-b border-line bg-dark py-20">
      <Container size="md">
        ...
        <ul className="mt-10 space-y-3">
          {howto.resinRules.bullets?.map((bullet, i) => (
            <RevealOnScroll key={bullet.id} delay={i * 0.04}>
              <li className="flex items-start gap-4 rounded-lg border-2 border-dark bg-dark-2 p-5 shadow-sticker-sm">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          <RevealOnScroll>
            <div className="relative rounded-xl border-2 border-dark bg-cream p-6 text-dark shadow-sticker">
              <span className="absolute right-4 top-4 flex h-10 w-10 items-center justify-center rounded-full border-2 border-dark bg-yellow">
              ...
              <div className="mt-4 flex h-24 items-center justify-center rounded-md border-2 border-dashed border-dark/30 bg-cream/50">
                <div className="h-14 w-14 rounded-md border-2 border-dark bg-violet" />
              </div>
            </div>
          </RevealOnScroll>

          <RevealOnScroll delay={0.05}>
            <div className="relative rounded-xl border-2 border-dark bg-dark-2 p-6 text-cream shadow-sticker">
              <span className="absolute right-4 top-4 flex h-10 w-10 items-center justify-center rounded-full border-2 border-dark bg-red">
