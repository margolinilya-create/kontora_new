...
export function DesignInKontora() {
  return (
    <section id="design-v-kontore" className="bg-bg-surface py-20 md:py-28">
      <Container size="lg">
        <RevealOnScroll>
          <div className="relative overflow-hidden rounded-xl  bg-violet text-white shadow-soft-lg">
            <div className="noise-overlay relative grid gap-8 p-10 md:grid-cols-[1.2fr_1fr] md:gap-12 md:p-16">
              ...
              <div
                ...
                aria-hidden="true"
              >
                <div className="relative flex h-48 w-48 rotate-[-8deg] items-center justify-center rounded-full  bg-yellow shadow-soft-lg">
                  <span className="font-display text-4xl font-bold uppercase text-yellow-ink">
                    Нарисуем!
                  </span>
                  <span className="absolute -top-4 -right-4 flex h-10 w-10 items-center justify-center rounded-full  bg-red text-lg font-bold text-white">
                    ★
                  </span>
                </div>
              </div>
